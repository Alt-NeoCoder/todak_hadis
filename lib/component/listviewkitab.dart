...
class ListViewKitab extends StatefulWidget {
  @override
  _ListViewKitab createState() => _ListViewKitab();
}

class _ListViewKitab extends State<ListViewKitab> {
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        style: const TextStyle(
                          fontSize: 12.0,
                            color: Color.fromARGB(255, 34, 150, 238),
                            fontWeight: FontWeight.bold,
                            fontFamily: 'Montserrat-bold'
                          ),
                        ),
